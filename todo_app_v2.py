...
class TaskManager:                                                      # TaskManger class 
    ...
    def run(self):                                                      # main function containing while running and conditional logic
        user_input = ""
        running = True
        while running:                                                  
            print("please select one of the following options:")        # Text based UI
            print('-------------------------------------------')
            ...
            user_input = input("Enter 1-5: ")                           # User input
